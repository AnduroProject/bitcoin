...
template <typename I, int BITS, I MOD>
NO_SANITIZE_MEMORY I MulWithClMulReduce(I a, I b)
{
...
template <typename I, int BITS, int POS>
NO_SANITIZE_MEMORY I MulTrinomial(I a, I b)
{
    static constexpr I MASK = Mask<BITS, I>();
...
template <typename I, int B, I MOD, I (*MUL)(I, I), typename F, const F* SQR, const F* SQR2, const F* SQR4, const F* SQR8, const F* SQR16, const F* QRT, typename T, const T* LOAD, const T* SAVE>
struct GenField {
