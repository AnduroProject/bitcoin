...
static std::vector<RPCArg> CreateTxDoc()
{
    return {
        ...
        {"assetInfo", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "Additional parameters for asset creation", {{"assettype", RPCArg::Type::NUM, RPCArg::Optional::NO, "The asset type"}, {"precision", RPCArg::Type::NUM, RPCArg::Optional::NO, "Precision number for token"}, {"ticker", RPCArg::Type::STR, RPCArg::Optional::NO, "The ticker symbol"}, {"headline", RPCArg::Type::STR, RPCArg::Optional::NO, "The headline"}, {"payload", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The payload"}, {"payloaddata", RPCArg::Type::STR, RPCArg::Optional::NO, "The payload data"}}}};
}
    ...
    return RPCHelpMan{
        ...
        RPCResult{
            ...
            "",
            {
                ...
                {RPCResult::Type::OBJ, "segwit", /*optional=*/true, "Result of a witness output script wrapping this redeem script (not returned for types that should not be wrapped)", {
...
static RPCHelpMan utxoupdatepsbt()
{
    return RPCHelpMan{
        ...
        RPCResult{RPCResult::Type::STR, "", "The base64-encoded partially signed transaction with inputs updated"},
...
static RPCHelpMan joinpsbts()
{
    return RPCHelpMan{
        ...
        {{"txs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The base64 strings of partially signed transactions", {{"psbt", RPCArg::Type::STR, RPCArg::Optional::NO, "A base64 string of a PSBT"}}}},
        RPCResult{
            RPCResult::Type::STR, "", "The base64-encoded partially signed transaction"},
        RPCExamples{
...
RPCHelpMan descriptorprocesspsbt()
{
    return RPCHelpMan{
        ...
        RPCExamples{HelpExampleCli("descriptorprocesspsbt", "\"psbt\" \"[\\\"descriptor1\\\", \\\"descriptor2\\\"]\"") + HelpExampleCli("descriptorprocesspsbt", "\"psbt\" \"[{\\\"desc\\\":\\\"mydescriptor\\\", \\\"range\\\":21}]\"")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
