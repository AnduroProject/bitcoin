...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        ...
        RPCExamples{HelpExampleCli("validateaddress", "\"" + EXAMPLE_ADDRESS[0] + "\"") + HelpExampleRpc("validateaddress", "\"" + EXAMPLE_ADDRESS[0] + "\"")},
...
static RPCHelpMan getdescriptorinfo()
{
    ...
    return RPCHelpMan{
        ...
        RPCExamples{"Analyse a descriptor\n" + HelpExampleCli("getdescriptorinfo", "\"" + EXAMPLE_DESCRIPTOR + "\"") + HelpExampleRpc("getdescriptorinfo", "\"" + EXAMPLE_DESCRIPTOR + "\"")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
                ...
                {
                    {
                        RPCResult::Type::ARR,
                        "",
                        "The derived addresses for a multipath descriptor expansion",
                        {
