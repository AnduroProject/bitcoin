            ...
            RPCResult{"when action=='start'; only returns after scan completes", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::ARR, "unspents", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::BOOL, "is_asset", "Identify it is asset unspent or native currency unspent"},
                        {RPCResult::Type::BOOL, "is_controller", "Identify it is asset controller unspent or not"},
                    }},
                }},
                {RPCResult::Type::STR_AMOUNT, "total_amount", "The total amount of all found unspent outputs in " + CURRENCY_UNIT},
                {RPCResult::Type::STR_AMOUNT, "total_asset", "The total asset of all found unspent outputs"},
            }},
            scan_result_abort,
