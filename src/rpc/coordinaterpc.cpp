...
static RPCHelpMan getPendingCommitments()
{
    return RPCHelpMan{
        ...
        RPCResult{
            ...
            "",
            {
                {RPCResult::Type::ARR, "commitments", "", {{RPCResult::Type::OBJ, "", "", {
                                                                                              {RPCResult::Type::NUM, "n", "block_height"},
                                                                                          }}}},
            },
        },
        RPCExamples{HelpExampleCli("getpendingcommitment", "")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
...
static RPCHelpMan listAllAssets()
{
    return RPCHelpMan{
        ...
        RPCResult{
            ...
            "",
            {
                {RPCResult::Type::ARR, "assets", "", {{RPCResult::Type::OBJ, "", "", {
        ...
        RPCExamples{HelpExampleCli("listallassets", "")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
...
static RPCHelpMan listMempoolAssets()
{
    return RPCHelpMan{
        ...
        RPCExamples{HelpExampleCli("listmempoolassets", "")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            UniValue result(UniValue::VOBJ);
            UniValue assets(UniValue::VARR);
