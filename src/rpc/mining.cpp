...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{
        ...
        RPCExamples{"\nGenerate 11 blocks to myaddress\n" + HelpExampleCli("generatetoaddress", "11 \"myaddress\"") + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated bitcoin to with:\n" + HelpExampleCli("getnewaddress", "")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
...
static RPCHelpMan getmininginfo()
{
    return RPCHelpMan{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            next.pushKV("difficulty", GetDifficulty(next_index.nBits));
...
static RPCHelpMan submitauxblock()
{
    return RPCHelpMan{
        ...
        RPCExamples{
            HelpExampleCli("submitauxblock", "\"hash\" \"serialised auxpow\"") + HelpExampleRpc("submitauxblock", "\"hash\" \"serialised auxpow\"")},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
